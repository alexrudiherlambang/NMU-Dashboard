...
class ctele_dapat extends CI_Controller {

   function __construct() {
      parent::__construct();
      $this->load->model('mtele_dapat');
   ...
   function index() {
      ...
      $this->load->view('content/vsuperuser/vtele_dapat/vtele_dapat');
   }
   ...
   function pendapatan() {
      ...
      $data['total_rsg'] = $this->mtele_dapat->msum_rsg($tglawal, $tglakhir);
      $data['total_rst'] = $this->mtele_dapat->msum_rst($tglawal, $tglakhir);
      $data['total_rsp'] = $this->mtele_dapat->msum_rsp($tglawal, $tglakhir);
      $data['total_rsmu'] = $this->mtele_dapat->msum_rsmu($tglawal, $tglakhir);
      $data['total_urj'] = $this->mtele_dapat->msum_urj($tglawal, $tglakhir);
      ...
      $data['rinci_rsg'] = $this->mtele_dapat->mrinci_rsg($tglawal, $tglakhir);
      $data['rinci_rst'] = $this->mtele_dapat->mrinci_rst($tglawal, $tglakhir);
      $data['rinci_rsp'] = $this->mtele_dapat->mrinci_rsp($tglawal, $tglakhir);
      $data['rinci_rsmu'] = $this->mtele_dapat->mrinci_rsmu($tglawal, $tglakhir);
      $data['rinci_urj'] = $this->mtele_dapat->mrinci_urj($tglawal, $tglakhir);
      ...
      if ($lokasi == ""){
         $log = array(
            ...
            'action'	   => 'Show Tabel Pendapatan Telemedicine',
         );
      }else{
         $log = array(
            'id'		   => $this->session->userdata("id"),
      ...
      $this->load->view('content/vsuperuser/vtele_dapat/vhasil_tele_dapat',$data);
   }
   ...
   function grafik_pendapatan() {
      ...
      $this->load->view('content/vsuperuser/vtele_dapat/vgrafik_tele_dapat');
   }
   ...
   function grafik_hasil_pendapatan() {
      ...
      if ($jenis == "SEMUA") {
         $grafik = $this->mtele_dapat->mshow_all_grafik_all_jenis($tglawal,$tglakhir,$lokasi,$jenis,$nama);
         ...
         $graf_pie = $this->mtele_dapat->mshow_all_pie_all_jenis($tglawal,$tglakhir,$lokasi,$jenis,$nama);
         ...
         $grafik = $this->mtele_dapat->mshow_all_grafik($tglawal,$tglakhir,$lokasi,$jenis,$nama);
         $grafik_kp = $this->mtele_dapat->mshow_all_grafik_kp($tglawal,$tglakhir,$lokasi,$jenis,$nama);
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->load->view('content/vsuperuser/vtele_dapat/vgrafik_hasil_tele_dapat',$data);
         }
      }
   }
