...
class ckunjungan_BPJS extends CI_Controller {
   ...
   function index() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_BPJS/vkunjungan_BPJS');
   }
   ...
   function grafik_kunjungan_bpjs() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_bpjs/vgrafik_kunjungan_bpjs', $data);
   }
   ...
   function export_xls() {
      ...
      if (isset($_POST['exportType'])) {
         ...
         if ($exportType == 'detail') {
            ...
            $this->load->helper('exportexcel');
            $namaFile = "Tabel Kunjungan BPJS / NON BPJS.xls";
