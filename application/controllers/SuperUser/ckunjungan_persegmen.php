...
class ckunjungan_persegmen extends CI_Controller {
   ...
   function kunjungan() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_persegmen/vhasil_kunjungan_persegmen',$data);
   }
   ...
   function grafik_persegmen() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_persegmen/vgrafik_kunjungan_persegmen', $data);
   }
   ...
   function grafik_hasil_kunjungan() {
      ...
      if ($jenis == "SEMUA") {
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->mkunjungan_persegmen->insert_log($log);
            $this->load->view('content/vsuperuser/vkunjungan_persegmen/vgrafik_hasil_kunjungan_persegmen_all',$data);
         }
      }else{
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->load->view('content/vsuperuser/vkunjungan_persegmen/vgrafik_hasil_kunjungan_persegmen',$data);
         }
      }
   }
