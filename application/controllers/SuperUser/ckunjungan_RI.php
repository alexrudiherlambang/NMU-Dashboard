...
class ckunjungan_RI extends CI_Controller {
   ...
   function index() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_RI/vkunjungan_RI');
   }
   ...
   function kunjungan() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_RI/vhasil_kunjungan_RI',$data);
   }
   ...
   function grafik_kunjungan_RI() {
      ...
      $this->load->view('content/vsuperuser/vkunjungan_RI/vgrafik_kunjungan_RI', $data);
   }
   ...
   function grafik_hasil_kunjungan() {
      ...
      if ($jenis == "SEMUA") {
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->mkunjungan_RI->insert_log($log);
            $this->load->view('content/vsuperuser/vkunjungan_RI/vgrafik_hasil_kunjungan_RI_all',$data);
         }
      }else{
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->load->view('content/vsuperuser/vkunjungan_RI/vgrafik_hasil_kunjungan_RI',$data);
         }
      }
   }
