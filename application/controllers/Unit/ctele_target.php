...
class ctele_target extends CI_Controller {
   ...
   function grafik_kunjungan() {
      ...
      $data['jenis'] = $this->mtele_target->mshow_all_jenis($optionSelected);
      $this->load->view('content/vunit/vtele_target/vgrafik_tele_target', $data);
   }
   ...
   function grafik_hasil_kunjungan() {
      ...
      $jenis2 = $this->mtele_target->mshow_all_jenis($this->session->userdata("tlok"));   
      if (empty($hasiltanggal)) {
         ...
         $this->load->view('content/vunit/vtele_target/vgrafik_hasil_tele_target',$data);
      }
   }
