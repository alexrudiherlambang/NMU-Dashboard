...
class claba_rugi extends CI_Controller {
   ...
   function index() {
      ...
      $this->load->view('content/vunit/vlaba_rugi/vlaba_rugi');
   }
   ...
   function grafik_laba_rugi() {
      ...
      $this->load->view('content/vunit/vlaba_rugi/vgrafik_laba_rugi', $data);
   }
   ...
   function grafik_hasil_laba_rugi() {
      ...
      if ($jenis == "SEMUA") {
         ...
         $this->mlaba_rugi->insert_log($log);
         $this->load->view('content/vunit/vlaba_rugi/vgrafik_hasil_laba_rugi_all',$data);
         ...
         $this->mlaba_rugi->insert_log($log);
         $this->load->view('content/vunit/vlaba_rugi/vgrafik_hasil_laba_rugi',$data);
      }
   }
   ...
   function export_xls() {
      ...
      if (isset($_POST['exportType'])) {
         ...
         if ($exportType == 'detail') {
            ...
            $this->load->helper('exportexcel');
            $namaFile = "Detail Potensi Laba / Rugi.xls";
            $judul = "Detail Potensi Laba / Rugi";
            $tablehead = 0;
            $tablebody = 1;
            $nourut = 1;
            //penulisan header
            ...
            foreach ($pilihan as $p) {
               $kellabarugi = $p;
               foreach ($this->mlaba_rugi->mshow_all_potensi($nama, $kellabarugi, $tglawal, $tglakhir) as $data) {
                  $kolombody = 0;
