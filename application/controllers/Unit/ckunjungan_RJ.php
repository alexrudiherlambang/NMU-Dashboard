...
class ckunjungan_RJ extends CI_Controller {
   ...
   function grafik_kunjungan_RJ() {
      ...
      $this->load->view('content/vunit/vkunjungan_RJ/vgrafik_kunjungan_RJ',$data);
   }
   ...
   function grafik_hasil_kunjungan() {
      ...
      if ($jenis == "SEMUA") {
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->mkunjungan_RJ->insert_log($log);
            $this->load->view('content/vunit/vkunjungan_RJ/vgrafik_hasil_kunjungan_RJ_all',$data);
         }
      }else{
         ...
         if (empty($hasiltanggal)) {
            ...
            $this->load->view('content/vunit/vkunjungan_RJ/vgrafik_hasil_kunjungan_RJ',$data);
         }
      }
   }
