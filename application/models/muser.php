...
class muser extends ci_model {
   ...
   function mselect_role_user($id) {
      $this->db = $this->load->database('local', TRUE);
      $this->db->select('fx_nmuser(id) as nama, tum, tkok1, tkok2, tkok3, tkok4, tkok5, tkoksk, tkoktt, tkokhp, tkokbor, tkkp1, tkkp2, tkkp3, tkkb, tkklr, tid, ttk, ttt, ttp, gtk, gtt, gtp, tmn, tmp, tmuk, tdr,imp,tpp,gpp,ffl,tmh,foc,fops,fopd,fon,fouac,tpl,tpkk,tppd,gpl,gpkk,gppd, mdr, otoritas');
