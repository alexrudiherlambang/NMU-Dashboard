            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <?php if ($this->session->userdata("imp") == "1"): ?>
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="<?php echo site_url('Unit/cHCIS/Master_Pekerja') ?>">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <?php if ($this->session->userdata("tpp") == "1"): ?>
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="<?php echo site_url('Unit/cHCIS/tabel_populasi') ?>">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <?php if ($this->session->userdata("gpl") == "1"): ?>
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="<?php echo site_url('Unit/cgrafik_HSSE/limbah') ?>">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Limbah</span>
                            ...
                            <?php if ($this->session->userdata("gpkk") == "1"): ?>
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="<?php echo site_url('Unit/cgrafik_HSSE/kejadian_kecelakaan') ?>">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Kejadian Kecelakaan</span>
                            ...
                            <?php if ($this->session->userdata("gppd") == "1"): ?>
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="<?php echo site_url('Unit/cgrafik_HSSE/property_damage') ?>">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Property Damage</span>
