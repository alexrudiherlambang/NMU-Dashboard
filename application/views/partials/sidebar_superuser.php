            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <?php if ($this->session->userdata("tid") == "1"): ?>
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="<?php echo site_url('SuperUser/cimport_tele') ?>">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <?php if ($this->session->userdata("ttk") == "1"): ?>
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="<?php echo site_url('SuperUser/ctele_kunjung') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                ...
                                <?php if ($this->session->userdata("ttt") == "1"): ?>
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="<?php echo site_url('SuperUser/ctele_target') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                        ...
                        <?php if ($this->session->userdata("ttp") == "1"): ?>
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="<?php echo site_url('SuperUser/ctele_dapat') ?>">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Pendapatan</span>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <?php if ($this->session->userdata("gtt") == "1"): ?>
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="<?php echo site_url('SuperUser/ctele_target/grafik_kunjungan') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Target Kunjungan</span>
                ...
                <?php if ($this->session->userdata("tdr") == "1"): ?>
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="<?php echo site_url('SuperUser/creport') ?>">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <?php if ($this->session->userdata("ffl") == "1"): ?>
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="<?php echo site_url('SuperUser/cform_HSSE/limbah') ?>">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <?php if ($this->session->userdata("foc") == "1"): ?>
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="<?php echo site_url('SuperUser/cform_HSSE/clasification') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                ...
                <?php if ($this->session->userdata("mdr") == "1"): ?>
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="<?php echo site_url('SuperUser/cmquery') ?>">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                                        <span class="svg-icon svg-icon-primary svg-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Communication/Clipboard-list.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
