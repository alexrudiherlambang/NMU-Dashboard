        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3">
                    <!--begin::Menu- wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-40px h-40px w-md-50px h-md-50px"
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-primary">
                                                    ...
                                                    <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Files/Selected-file.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold"><?php echo $notif->nosurat ?>
                                                </a>
                                                <div class="text-gray-400 fs-7"><?php echo $notif->nmrekanan ?></div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        ...
                                        <?php 
                                            $biday = new DateTime($notif->tglnotif);
                                            $today = new DateTime();

                                            $diff = $today->diff($biday);   
                                            $bulan = $diff->m;    
                                            $hari = $diff->d;?>    
                                        <?php echo $bulan ?> bulan <?php echo $hari ?> hari lagi
                                        </span>
                                        <!--end::Label-->
                                    </div>
                                    <?php
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="<?php echo site_url('SuperUser/cpks/penyedia') ?>"
