...
<html lang="en">
	...
	<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('<?php echo base_url(); ?>assets/media/auth/bg8.jpg'); } [data-theme="dark"] body { background-image: url('<?php echo base_url(); ?>assets/media/auth/bg8-dark.jpg'); }</style>
			<!--end::Page bg image-->
						...
						<div class="card-body py-15 py-lg-20">
							...
							<div class="mb-7">
								<a href="../../demo1/dist/index.html" class="">
									<img alt="Logo" src="<?php echo base_url(); ?>assets/media/logos/custom-2.svg" class="h-40px" />
								</a>
							</div>
							<!--end::Logo-->
							<!--begin::Title-->
							...
							<!--begin::Illustration-->
							<div class="mb-0">
								<img src="<?php echo base_url(); ?>assets/media/auth/welcome.png" class="mw-100 mh-300px theme-light-show" alt="" />
								<img src="<?php echo base_url(); ?>assets/media/auth/welcome-dark.png" class="mw-100 mh-300px theme-dark-show" alt="" />
							</div>
							<!--end::Illustration-->
							<!--begin::Link-->
							<div class="mb-0">
								<a href="../../demo1/dist/index.html" class="btn btn-sm btn-primary">Go To Dashboard</a>
							</div>
							<!--end::Link-->
						</div>
					</div>
