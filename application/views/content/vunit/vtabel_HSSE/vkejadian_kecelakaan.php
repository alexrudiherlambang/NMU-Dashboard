                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-xl-5 fv-row">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <input class="form-control form-control-solid ps-12" type="month" name="period" placeholder="Pick a date" id="period" required="required" value="<?php echo date('Y-m');?>"/>
                                                        </div>
                                                    </div>
                                                    <!--begin::Col-->
                                                </div>
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5">
                                                ...
                                                <tbody class="text-gray-600 fw-semibold">
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px"><b>Classification</b></td>
                                                        <td class="text-center min-w-150px">NoA</td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background-color: #0F4ED8; color: #ffffff; vertical-align: middle;" class="text-center w-10px pe-5"><b></b></td>
                                                        <td class="text-center w-10px pe-5"><b>2</b></td>
                                                        <td class="text-center min-w-100px">Personnal Safety</td>
                                                        <td class="text-center min-w-150px"><b>Fatality</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">Personnal Safety</td>
                                                        <td class="text-center min-w-150px"><b>Days Away From Work/Lost Time Incident</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">Personnal Safety</td>
                                                        <td class="text-center min-w-150px"><b>Restricted Work Day Case</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">Personnal Safety</td>
                                                        <td class="text-center min-w-150px"><b>Medical Treatment Case</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">Personnal Safety</td>
                                                        <td class="text-center min-w-150px"><b>First Aid</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">Property Damage</td>
                                                        <td class="text-center min-w-150px"><b>Property Damage >1 juta USD</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">Property Damage</td>
                                                        <td class="text-center min-w-150px"><b>Property Damage 100 ribu - 1 juta USD</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background-color: #0F4ED8; color: #ffffff; vertical-align: middle;" class="text-center w-10px pe-5"><b></b></td>
                                                        <td class="text-center w-10px pe-5"><b>9</b></td>
                                                        <td class="text-center min-w-100px">Property Damage</td>
                                                        <td class="text-center min-w-150px"><b>Property Damage 10 ribu - 100 juta USD</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background-color: #0F4ED8; color: #ffffff; vertical-align: middle;" class="text-center w-10px pe-5"><b></b></td>
                                                        <td class="text-center w-10px pe-5"><b>10</b></td>
                                                        <td class="text-center min-w-100px">Other</td>
                                                        <td class="text-center min-w-150px"><b>Near Miss</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background-color: #0F4ED8; color: #ffffff; vertical-align: middle;" class="text-center w-10px pe-5"><b></b></td>
                                                        <td class="text-center w-10px pe-5"><b>11</b></td>
                                                        <td class="text-center min-w-100px">Other</td>
                                                        <td class="text-center min-w-150px"><b>Unsafe Action/Condition</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
