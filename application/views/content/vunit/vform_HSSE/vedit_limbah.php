                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                        <!--begin::Form-->
                                        <form class="form" method="post" action="<?php echo site_url(); ?>Unit/cform_HSSE/update_limbah" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            <!--begin::Card-->
                                                    ...
                                                    <input type="hidden" class="form-control form-control-solid" name="id_limbah" value="<?php echo $limbah->id_limbah; ?>">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                ...
                                                                <!-- <select class="form-control form-control-solid select2" name="unit" Disabled>
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <div class="position-relative d-flex align-items-center">
                                                                    ...
                                                                    <!--end::Svg Icon-->
                                                                    <input class="form-control form-control-solid ps-12" type="month" name="periode" required="required" value="<?php echo $limbah->tahun . '-' . str_pad($limbah->bulan, 2, '0', STR_PAD_LEFT); ?>" />
                                                                </div>
                                                            </div>
                                                            <!--begin::Col-->
                                                        </div>
