                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <?php echo anchor('Unit/cform_HSSE/input_man_hour', '+ Form Man Hour', array('class' => 'btn btn-sm btn-success', 'type' => 'button')) ?>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                if ($man_hour->unit == $this->session->userdata("tlok")) :
                                                ?>
                                                <!--begin::Table row-->
                                                <tr>
                                                    <!--begin::Checkbox-->
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            <a href="<?php echo site_url("Unit/cform_HSSE/edit_man_hour/" . $man_hour->id_man_hour) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            <a href="<?php echo site_url("Unit/cform_HSSE/delete_man_hour/" . $man_hour->id_man_hour) ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" onclick="return confirm('Anda yakin hapus pendaftaran ini?');">
                                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                                <span class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/General/Visible.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--begin::Order ID=-->
                                                    <td class="text-center pe-0" data-kt-ecommerce-order-filter="order_id">
                                                        <a class="text-gray-800 text-hover-primary fw-bold"><s><?php echo $man_hour->nip ?></s></a>
                                                    </td>
                                                    <!--end::Order ID=-->
                                                    <!--end::Customer=-->
                                                    <!--begin::Status=-->
                                                    <td class="text-center pe-0" data-order="<?php echo $man_hour->napeg ?>">
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a class="text-gray-800 text-hover-primary fs-5 fw-bold"><s><?php echo $man_hour->napeg ?></s></a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </td>
                                                    <!--end::Status=-->
                                                    <!--begin::Total=-->
                                                    <td class="text-center pe-0">
                                                        <span class="fw-bold"><s><?php echo $man_hour->status ?></s></span>
                                                    </td>
                                                    <!--end::Total=-->
                                                    <!--begin::Date Added=-->
                                                    <td class="text-center" data-order="<?php echo $man_hour->fungsi ?>">
                                                        <div class="badge badge-light-success"><s><?php echo $man_hour->unit ?></s></div>
                                                        |
                                                        <span class="fw-bold"><s><?php echo $man_hour->fungsi ?></s></span>
                                                    </td>
                                                    <!--end::Date Added=-->
                                                    <!--begin::Date Modified=-->
                                                    <td class="text-center" data-order="<?php echo $man_hour->unit ?>">
                                                    <span class="fw-bold">
                                                        <s><?php echo strftime('%B %Y', strtotime($man_hour->tahun . '-' . str_pad($man_hour->bulan, 2, '0', STR_PAD_LEFT)));?></s>
                                                    </span>
                                                    </td>
                                                    <!--end::Date Modified=-->
                                                    <!--begin::Customer=-->
                                                    <td class="text-center">
                                                        <div class="d-flex align-items-center">
                                                            <div class="ms-5">
                                                                <!--begin::Title-->
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><s><?php echo $man_hour->man_hour ?></s></a>
                                                                <!--end::Title-->
                                                            </div>
                                                        </div>
                                                    </td>
