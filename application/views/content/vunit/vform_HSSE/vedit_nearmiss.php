                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="d-flex flex-column mb-10 fv-row">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                                    <input class="form-check-input" type="radio" name="sub_jenis" value="Nearmiss" id="flexRadioLg" <?php echo ($other->sub_jenis === 'Nearmiss') ? 'checked' : ''; ?>/>
                                                    ...
                                                    <div class="box-footer">
                                                        <center>
                                                            ...
                                                            <?php echo anchor('Unit/cform_HSSE/nearmiss', 'Batal', array('class' => 'btn btn-danger')) ?>
                                                        </center>
                                                    </div>
                                                    <!-- /.box-footer -->
                                                </div>
