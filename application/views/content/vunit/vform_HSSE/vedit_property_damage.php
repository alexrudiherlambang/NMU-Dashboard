                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                        <!--begin::Form-->
                                        <form class="form" method="post" action="<?php echo site_url(); ?>Unit/cform_HSSE/update_property_damage" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            <!--begin::Card-->
                                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <input type="hidden" class="form-control form-control-solid" name="jenis" value="<?php echo $property_damage->jenis; ?>">                                                   
                                                    <input type="hidden" class="form-control form-control-solid" name="id_property" value="<?php echo $property_damage->id_property; ?>">
                                                    ...
                                                    <div class="d-flex flex-column mb-10 fv-row">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="email" class="form-control form-control-solid" name="email" value="<?php echo $property_damage->email; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                ...
                                                                <!-- <select class="form-control form-control-solid select2" name="unit" >
                                                                    ...
                                                                    <option <?php if ($property_damage->unit == "KP") echo "selected"; ?> value="KP">Kantor Pusat</option>
                                                                    <option <?php if ($property_damage->unit == "RSG") echo "selected"; ?> value="RSG">Rumah Sakit Gatoel</option>
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="number" class="form-control form-control-solid" name="nip" value="<?php echo $property_damage->nip; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="text" class="form-control form-control-solid" name="napeg" value="<?php echo $property_damage->napeg; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <select class="form-control form-control-solid select2" name="status" >
                                                                    <option selected="selected">-</option>
                                                                    <option <?php if ($property_damage->status == "PWT") echo "selected"; ?>>PWT</option>
                                                                    <option <?php if ($property_damage->status == "PWTT") echo "selected"; ?>>PWTT</option>
                                                                    <option <?php if ($property_damage->status == "OS") echo "selected"; ?>>OS</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="text" class="form-control form-control-solid" name="fungsi" value="<?php echo $property_damage->fungsi; ?>">
                                                            </div>
                                                        </div>
                                                        <hr class="my-3">
                                                        <div class="fs-5 fw-bold form-label mb-3">Kerusakan Pribadi
                                                        <hr class="my-3"></div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="text" class="form-control form-control-solid" name="nama_alat" value="<?php echo $property_damage->nama_alat; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <textarea class="form-control form-control-solid" rows="3" name="detil_item"><?php echo $property_damage->detil_item; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <hr class="my-3">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="text" class="form-control form-control-solid" name="penyebab" value="<?php echo $property_damage->penyebab; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <textarea class="form-control form-control-solid" rows="3" name="deskripsi" placeholder="Input Deskripsi Kejadian"><?php echo $property_damage->deskripsi; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <div class="col-xl-3">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <textarea class="form-control form-control-solid" rows="3" name="rtl" placeholder="Input Rencana Tindak Lanjut Kejadian"><?php echo $property_damage->rtl;?></textarea>
                                                            </div>
                                                        </div>
                                                        <hr class="my-3">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="text" class="form-control form-control-solid" name="lokasi" value="<?php echo $property_damage->lokasi; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-5">
                                                            <!--begin::Col-->
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <div class="position-relative d-flex align-items-center">
                                                                    ...
                                                                    <!--end::Svg Icon-->
                                                                    <input class="form-control form-control-solid ps-12" type="datetime-local" name="tgl_waktu" value="<?php echo $property_damage->tgl_waktu; ?>" id="tglawal" required="required"/>
                                                                </div>
                                                            </div>
                                                            <!--begin::Col-->
                                                        </div>
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                            <img  src='<?=base_url()?>assets/media/images/ktp/<?php echo $property_damage->bukti;?>' height="100">
                                                    ...
                                                    <div class="box-footer">
                                                        <center>
                                                            ...
                                                            <?php echo anchor('Unit/cform_HSSE/property_damage', 'Batal', array('class' => 'btn btn-danger')) ?>
                                                        </center>
                                                    </div>
                                                    <!-- /.box-footer -->
                                                </div>
