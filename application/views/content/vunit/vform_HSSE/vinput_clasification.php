                                        ...
                                        <form class="form" method="post" action="<?php echo site_url(); ?>Unit/cform_HSSE/insert_other" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            ...
                                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <input type="hidden" class="form-control form-control-solid" name="jenis" value="clasification">                                                   
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                                    <input class="form-check-input" type="checkbox" name="sub_jenis" value="NOA" id="flexRadioLg" checked />
