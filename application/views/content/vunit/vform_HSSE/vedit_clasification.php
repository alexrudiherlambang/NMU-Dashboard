                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                        <!--begin::Form-->
                                        <form class="form" method="post" action="<?php echo site_url(); ?>Unit/cform_HSSE/update_other" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            <!--begin::Card-->
                                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="d-flex flex-column mb-2 fv-row">
                                                        <!--begin::Label-->
                                                        <div class="fs-5 fw-bold form-label mb-3">Edit Data Clasification
                                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Ubah data clasification dengan benar"></i></div>
                                                        <!--end::Label-->
                                                    </div>
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                                    <input class="form-check-input" type="radio" name="sub_jenis" value="NOA" id="flexRadioLg" <?php echo ($other->sub_jenis === 'NOA') ? 'checked' : ''; ?>/>
                                                    ...
                                                    <div class="box-footer">
                                                        <center>
                                                            ...
                                                            <?php echo anchor('Unit/cform_HSSE/clasification', 'Batal', array('class' => 'btn btn-danger')) ?>
                                                        </center>
                                                    </div>
                                                    <!-- /.box-footer -->
                                                </div>
