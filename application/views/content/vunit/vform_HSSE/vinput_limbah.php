                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                        <!--begin::Form-->
                                        <form class="form" method="post" action="<?php echo site_url(); ?>Unit/cform_HSSE/insert_limbah" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            <!--begin::Card-->
                                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="d-flex flex-column mb-2 fv-row">
                                                        <!--begin::Label-->
                                                        <div class="fs-5 fw-bold form-label mb-3">Input Data Limbah
                                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Tambahkan data limbah dengan benar"></i></div>
                                                        <!--end::Label-->
                                                    </div>
                                                    ...
                                                    <div class="d-flex flex-column mb-10 fv-row">
                                                        ...
                                                        <div class="row mb-5">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <textarea class="form-control form-control-solid" rows="3" name="rtl" placeholder="Input Rencana Tindak Lanjut Kejadian"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end::Invoice footer-->
                                                    ...
                                                    <div class="box-footer">
                                                        <center>
                                                            ...
                                                            <?php echo anchor('Unit/cform_HSSE/limbah', 'Batal', array('class' => 'btn btn-danger')) ?>
                                                        </center>
                                                    </div>
                                                    <!-- /.box-footer -->
                                                </div>
