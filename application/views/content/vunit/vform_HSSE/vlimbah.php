                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <!--end::Svg Icon-->
                                                <input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Limbah" />
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        <!--end::Card title-->
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <?php echo anchor('Unit/cform_HSSE/input_limbah', '+ Form Limbah', array('class' => 'btn btn-sm btn-success', 'type' => 'button')) ?>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                if ($limbah->unit == $this->session->userdata("tlok")) :
                                                ?>
                                                <!--begin::Table row-->
                                                <tr>
                                                    <!--begin::Checkbox-->
                                                    ...
                                                    <td class="text-center pe-0" data-kt-ecommerce-order-filter="order_id">
                                                        <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->nip ?></a>
                                                    </td>
                                                    <!--end::Order ID=-->
                                                    <!--end::Customer=-->
                                                    <!--begin::Status=-->
                                                    <td class="text-center pe-0" data-order="<?php echo $limbah->napeg ?>">
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a class="text-gray-800 text-hover-primary fs-5 fw-bold"><?php echo $limbah->napeg ?></a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </td>
                                                    <!--end::Status=-->
                                                    ...
                                                    <td class="text-center pe-0">
                                                        <span class="fw-bold"><?php echo $limbah->status ?></span>
                                                    </td>
                                                    <!--end::Total=-->
                                                    <!--begin::Date Added=-->
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex align-items-center">
                                                            <!--begin:: Avatar -->
                                                            <div class="ms-5">
                                                                <a class="text-gray-800">Suhu (oC) :</a></br>
                                                                <a class="text-gray-800">BOD (mg/L) : </a></br>
                                                                <a class="text-gray-800">COD (mg/L) : </a></br>
                                                                <a class="text-gray-800">TSS (mg/L) : </a></br>
                                                                <a class="text-gray-800">PH : </a></br>
                                                                <a class="text-gray-800">NH3 (mg/L) : </a></br>
                                                                <a class="text-gray-800">PO4 (mg/L) : </a></br>
                                                                <a class="text-gray-800">Coliform  (MPN/100ml): </a></br>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <div class="ms-5">
                                                                <!--begin::Title-->
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->suhu ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->bod ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->cod ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->tss ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->ph ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->nh3 ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->po4 ?></a></br>
                                                                <a class="text-gray-800 text-hover-primary fw-bold"><?php echo $limbah->coliform ?></a></br>
                                                                <!--end::Title-->
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            <a href="<?php echo site_url("Unit/cform_HSSE/edit_limbah/" . $limbah->id_limbah) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            <a href="<?php echo site_url("Unit/cform_HSSE/delete_limbah/" . $limbah->id_limbah) ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" onclick="return confirm('Anda yakin hapus pendaftaran ini?');">
                                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                                <span class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/General/Visible.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
