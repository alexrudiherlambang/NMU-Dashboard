...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
										...
										<div class="row gy-0 mb-1 mb-xl-12">
											...
											<div class="col-md-6">
												...
												<div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
													<!--begin::Body-->
													<div class="card-body">
															<form method="post" action="<?php echo site_url(); ?>Unit/cdetail_segmen/grafik_hasil_pendapatan" enctype="multipart/form-data">
																<div class="row mb-5">
																	<!--begin::Col-->
																	<div class="col-xl-4">
													...
													<tbody class="text-gray-600 fw-semibold">
														...
														<tr>
															<td style="text-align:center">
																<form method="post" action="<?php echo site_url(); ?>Unit/cdetail_segmen/export_xlsx">
	...
	<script>
		...
		function drawChart() {
			...
			['<?php echo $pie->kelsegmen;?>',<?php echo $pie->total_rsaldosampai/1000000; ?>],
			<?php endforeach;?>
			]);
