                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div class="card card-custom bg-primary">
                                ...
                                <div class="card-body pt-5">
                                    <!--begin::Item-->
                                    <?php if ($this->session->userdata("tlok") == "RSG") :?>
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Item-->
                                    <?php if ($this->session->userdata("tlok") == "RSP") :?>
                                    <div class="d-flex flex-stack">
                                        <!--begin::Section-->
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Item-->
                                    <?php if ($this->session->userdata("tlok") == "RST") :?>
                                    <div class="d-flex flex-stack">
                                        <!--begin::Section-->
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Item-->
                                    <?php if ($this->session->userdata("tlok") == "RSMU") :?>
                                    <div class="d-flex flex-stack">
                                        <!--begin::Section-->
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Item-->
                                    <?php if ($this->session->userdata("tlok") == "URJ") :?>
                                    <div class="d-flex flex-stack">
                                        <!--begin::Section-->
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <?php echo anchor('Unit/cimport_tele/ctambah_import_tele', '+ Upload File CSV', array('class' => 'btn btn-sm btn-success', 'type' => 'button')) ?>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            ...
                                                            <!-- <a href="<?php echo site_url("Unit/cimport_tele/cdelete_import/" . $import->kdtelemed) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"> -->
                                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                                <!-- <span class="svg-icon svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"> -->
                                                                    <!-- <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
