							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										Import Data CSV Utilitas Telemedicine</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<?php
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                        <!--begin::Form-->
                                        <form class="form" method="post" action="<?php echo site_url(); ?>Unit/cimport_tele/cinsert_import" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            <!--begin::Card-->
                                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="d-flex flex-column mb-15 fv-row">
                                                        <!--begin::Label-->
                                                        <div class="fs-5 fw-bold form-label mb-3">Input Data as CSV
                                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Tambahkan data dengan benar"></i></div>
                                                        <!--end::Label-->
                                                    </div>                                                        
                                                    ...
                                                    <div class="d-flex flex-column mb-10 fv-row">
                                                        <div class="row mb-8">
                                                            <div class="col-xl-3">
                                                                <div class="fs-6 fw-semibold mt-2 mb-3">Nama User</div>
                                                            </div>
                                                            <div class="col-xl-9 fv-row">
                                                                <input type="text" class="form-control form-control-solid" name="nama" value="<?php echo $this->session->userdata("nama") ?>" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-8">
                                                            <div class="col-xl-3">
                                                                <div class="fs-6 fw-semibold mt-2 mb-3">File CSV</div>
                                                            </div>
                                                            <div class="col-xl-9 fv-row">
                                                    ...
                                                    <div class="box-footer">
                                                        <center>
                                                            ...
                                                            <?php echo anchor('Unit/cimport_tele', 'Batal', array('class' => 'btn btn-danger')) ?>
                                                        </center>
                                                    </div>
                                                    <!-- /.box-footer -->
                                                </div>
