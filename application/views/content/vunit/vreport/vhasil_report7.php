                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-100px">Nama Dokter</th>
                                                        <th class="text-center min-w-100px">Nama Ahli</th>
		...
		$(document).ready(function(){
			...
			success: function(data) {
                ...
                $.each(data, function(index, item){
                    ...
                    row.append($('<td>').text(item.nmdokter)); 
                    row.append($('<td class="text-center">').text(item.nmahli));
                    row.append($('<td class="text-center">').text(item.tanggal));
                    row.append($('<td class="text-center">').text(item.nmkons));
                    row.append($('<td class="text-center">').text(item.keterangan));
                    row.append($('<td class="text-center">').text(item.harga));
                    tbody.append(row); 
                });
