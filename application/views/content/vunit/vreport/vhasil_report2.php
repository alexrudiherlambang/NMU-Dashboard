                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-100px">No. Billing</th>
                                                        <th class="text-center min-w-70px">No Bukti</th>
                                                        <th class="min-w-100px">Jns Transaksi</th>
		...
		$(document).ready(function(){
			...
			success: function(data) {
                ...
                $.each(data, function(index, item){
                    ...
                    row.append($('<td>').text(item.nobilling));
                    row.append($('<td>').text(item.jnstrans));
                    row.append($('<td>').text(item.nobukti));
                    row.append($('<td>').text(item.noposting));
                    row.append($('<td>').text(item.nmpasien));
                    row.append($('<td>').text(item.nmkons));
                    row.append($('<td class="text-center min-w-90px">').text(item.debet)); 
                    row.append($('<td class="text-center min-w-90px">').text(item.kredit));
