...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										Data Report Harian Query All Unit</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<?php
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="card card-flush">
                                    <div class="card-body border-0 pt-10">
                                        ...
                                        <center>
                                            <form method="post" action="<?php echo site_url(); ?>Unit/creport/report" enctype="multipart/form-data">
                                                <div class="row mb-4">
                                                    <!--begin::Col-->
                                                    <div class="col-xl-5">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <!--end::Svg Icon-->
                                                <input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Value" />
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        <!--end::Card title-->
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <form method="post" action="<?php echo site_url(); ?>Unit/creport/export_xlsx">
                                            ...
                                            <input class="form-control form-control-solid ps-12" type="hidden" name="jenis" required="required" value="<?php echo $jenis;?>" readonly/>
                                            <button type="submit" class="btn btn-sm btn-info">Export As Excel</button>
                                            </form>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-70px">No. Rekanan</th>
                                                        <th class="min-w-100px">Nama Rekanan</th>
                                                        <th class="text-center min-w-90px">Debet</th>
                                                        <th class="text-center min-w-90px">Kredit</th>
                                                        <th class="text-center min-w-90px">Jml. Uang</th>
                                                    </tr>
                                                    <!--end::Table row-->
                                                </thead>
                                                <!--end::Table head-->
    ...
    <script>
		$(document).ready(function(){
			$.ajax({
            url: '<?php echo site_url("Unit/creport/get_data/".$lokasi."/".$jenis."/".urlencode($tglawal)."/".urlencode($tglakhir)) ?>',
			type: 'GET',
			dataType: 'json',
			success: function(data) {
                ...
                $.each(data, function(index, item){
                    var row = $('<tr>');
                    row.append($('<td>').text(index + 1)); // nomor urut
                    row.append($('<td>').text(item.tanggal)); // tanggal
                    row.append($('<td>').text(item.noper)); // nomor rekanan
                    row.append($('<td>').text(item.naper)); // nama rekanan
                    row.append($('<td class="text-center min-w-90px">').text(item.debet)); // debet
                    row.append($('<td class="text-center min-w-90px">').text(item.kredit)); // kredit
                    row.append($('<td class="text-center min-w-90px">').text(item.jmluang)); // jumlah uang
