...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
											...
											<tbody class="text-gray-600 fw-semibold">
												<tr>
													...
													<div id="card_pendapatan" class="card-body">
														...
														<canvas id="pendapatan" width="300" height="100"></canvas><br>
													</div>
												</tr>
											</tbody>
										</table>
											...
											<tbody class="text-gray-600 fw-semibold">
												<tr>
													...
													<div id="card_labarugi" class="card-body">
														<b>(Dalam Juta)</b><br><br>
														<canvas id="labarugi" width="300" height="100"></canvas><br>
													</div>
												</tr>
											</tbody>
										</table>
											...
											<tbody class="text-gray-600 fw-semibold">
												<tr>
													...
													<div id="card_beban" class="card-body">
														<b>(Dalam Juta)</b><br><br>
														<canvas id="beban" width="300" height="100"></canvas><br>
													</div>
												</tr>
											</tbody>
										</table>
											...
											<tbody class="text-gray-600 fw-semibold">
												<tr>
													...
													<div id="card_kunjungan" class="card-body">
														<canvas id="kunjungan" width="300" height="100"></canvas><br>
													</div>
												</tr>
											</tbody>
										</table>
    ...
    <script>
		...
		var kunjungan = new Chart(ctx, {
			type: 'bar',
			data: {
				labels: [<?php echo json_encode($lokasi3)?>],
				datasets: [{
					label: 'Realisasi',
