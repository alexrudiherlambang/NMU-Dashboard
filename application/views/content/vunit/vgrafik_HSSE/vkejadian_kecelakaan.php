...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <script>
        ...
        anychart.onDocumentReady(function() {
            // Siapkan data untuk grafik piramida
            var data = [
                {x: 'Unsafe Action/Condition', value: 0},
                {x: 'Near Miss', value: 0},
                {x: 'First Aid', value: 0},
                {x: 'Medical Treatment Case', value: 0},
                {x: 'Restricted Work Day Case', value: 0},
                {x: 'Days Away From Work/Lost Time Incident', value: 0},
                {x: 'Fatality', value: 0}
            ];
