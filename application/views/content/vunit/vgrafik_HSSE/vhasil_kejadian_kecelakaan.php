...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										Grafik Performance Data Kejadian Kecelakaan</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<?php
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-0 pt-10">
                                        ...
                                        <div class="card-title"><center>
                                            <form method="post" action="<?php echo site_url(); ?>Unit/cgrafik_HSSE/hasil_kejadian_kecelakaan" enctype="multipart/form-data">
                                                <div class="row mb-4">
                                                    <div class="col-xl-5">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-xl-5 fv-row">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <input class="form-control form-control-solid ps-12" type="month" name="periode" placeholder="Pick a date" id="periode" required="required" value="<?php echo $periode;?>"/>                                                        </div>
                                                    </div>
                                                    <!--begin::Col-->
                                                </div>
                                                <center>
													...
													<tr>
														...
														<div class="card-body">
                                                            <div class="portlet-body">
                                                                <div id="container" class="pseudo-3d" style="width: 100%; height: 500px;"></div>
                                                            </div>
														</div>
													</tr>
												</tbody>
    ...
    <!-- Sisipkan pustaka AnyChart dari URL online -->
    <script src="https://cdn.anychart.com/releases/8.10.0/js/anychart-bundle.min.js"></script>
    <script>
        // Inisialisasi grafik piramida menggunakan AnyChart
        anychart.onDocumentReady(function() {
            var chartData = <?php echo $chartDataJSON; ?>;

            // Membuat grafik piramida
            var chart = anychart.pyramid(chartData);

            // Menghilangkan tulisan "trial version"
            chart.credits().enabled(false);

            // Menampilkan grafik pada elemen dengan ID "container"
