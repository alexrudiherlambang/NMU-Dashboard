                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <?php echo anchor('Unit/cmquery/ctambah_query', '+ Data User', array('class' => 'btn btn-sm btn-success', 'type' => 'button')) ?>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-end flex-shrink-0">
                                                            <a href="<?php echo site_url("Unit/cmquery/cedit_query/" . $query->id) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                            ...
                                                            <a href="<?php echo site_url("Unit/cmquery/cdelete_query/" . $query->id) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
