                                ...
                                <div class="card card-flush">
                                        ...
                                        <center>
                                            <form method="post" action="<?php echo site_url(); ?>SuperUser/creport/report" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-xl-5 fv-row">
                                                        <input list="list_daftar" class="form-control" id="jenis" name="jenis" placeholder="Ketik jenis Laporan yang Dikehendaki">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <?php echo anchor('SuperUser/creport/export_xlsx', 'Export As Excel', array('class' => 'btn btn-sm btn-info', 'type' => 'button')) ?>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="text-center min-w-70px">TGL. AWAL</th>
                                                    <th class="text-center min-w-100px">TGL. AKHIR</th>
                                                    <th class="text-center min-w-100px">URAIAN</th>
                                                    <th class="text-center min-w-100px">KET</th>
                                                    <th class="text-center min-w-100px">HASIL</th>
                                                </tr>
                                                <!--end::Table row-->
                                            </thead>
                                            <!--end::Table head-->
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-kt-ecommerce-order-filter="order_id">
                                                        <a class="text-gray-800 text-hover-primary fw-bold">USR1</a>
                                                    </td>
                                                    <!--end::Order ID=-->
                                                    <!--begin::Customer=-->
                                                    <td>
                                                    ...
                                                    <td class="text-center" data-order="2022-11-21">
                                                        <span class="fw-bold">2022-11-21</span>
                                                    </td>
                                                    <!--end::Date Added=-->
                                                    <!--begin::Date Modified=-->
                                                    <td class="text-center" data-order="2022-11-22">
                                                        <span class="fw-bold">2022-11-22</span>
                                                    </td>
                                                    <!--end::Date Modified=-->
                                                    <!--begin::Status=-->
