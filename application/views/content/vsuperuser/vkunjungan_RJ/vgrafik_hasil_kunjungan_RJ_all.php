							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										Grafik Kunjungan Rawat Jalan</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<?php
										...
										<div class="row gy-0 mb-1 mb-xl-12">
											...
											<div class="col-md-6">
												...
												<div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
													<!--begin::Body-->
													<div class="card-body">
															<form method="post" action="<?php echo site_url(); ?>SuperUser/ckunjungan_RJ/grafik_hasil_kunjungan" enctype="multipart/form-data">
																<div class="row mb-5">
																	<!--begin::Col-->
																	<div class="col-xl-4">
													...
													<tbody class="text-gray-600 fw-semibold">
														...
														<tr>
															<td style="text-align:center">
																<form method="post" action="<?php echo site_url(); ?>SuperUser/ckunjungan_RJ/export_xlsx">
