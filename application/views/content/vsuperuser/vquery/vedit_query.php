                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                        <!--begin::Form-->
                                        <form class="form" method="post" action="<?php echo site_url(); ?>SuperUser/cmquery/cupdate_query" id="kt_subscriptions_create_new" enctype="multipart/form-data">
                                            <!--begin::Card-->
                                            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <input class="form-control form-control-solid ps-12" type="hidden" name="id" placeholder="Pick a date" id="tglawal" required="required" value="<?php echo $query->id;?>" readonly/>
                                                        ...
                                                        <div class="row mb-8">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                <select class="form-select form-select-solid select2" name="unit" >
                                                                    ...
                                                                    <option <?php if ($query->unit == "RSG") echo "selected"; ?>>RSG</option>
                                                                    <option <?php if ($query->unit == "RST") echo "selected"; ?>>RST</option>
                                                                    <option <?php if ($query->unit == "RSP") echo "selected"; ?>>RSP</option>
                                                                    <option <?php if ($query->unit == "RSMU") echo "selected"; ?>>RSMU</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-8">
                                                            ...
                                                            <div class="col-xl-9 fv-row">
                                                                ...
                                                                <option value="<?php echo $query->kdjns ?>"><?php echo $query->jenis ?></option>
