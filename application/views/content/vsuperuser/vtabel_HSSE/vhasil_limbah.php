                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center min-w-75px">
                                                                    <?php if ($limbah_rsg->nh3 > "0.1"){
                                                                        echo '<div class="badge badge-light-danger">'.number_format($limbah_rsg->nh3, 1).'</div>';
                                                                    }else{
                                                                        echo '<div class="badge badge-light-success">'.number_format($limbah_rsg->nh3, 1).'</div>';
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td class="text-center min-w-75px">
                                                                    <?php if ($limbah_rst->nh3 > "0.1"){
                                                                        echo '<div class="badge badge-light-danger">'.number_format($limbah_rst->nh3, 1).'</div>';
                                                                    }else{
                                                                        echo '<div class="badge badge-light-success">'.number_format($limbah_rst->nh3, 1).'</div>';
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td class="text-center min-w-75px">
                                                                    <?php if ($limbah_rsp->nh3 > "0.1"){
                                                                        echo '<div class="badge badge-light-danger">'.number_format($limbah_rsp->nh3, 1).'</div>';
                                                                    }else{
                                                                        echo '<div class="badge badge-light-success">'.number_format($limbah_rsp->nh3, 1).'</div>';
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td class="text-center min-w-75px">
                                                                    <?php if ($limbah_rsmu->nh3 > "0.1"){
                                                                        echo '<div class="badge badge-light-danger">'.number_format($limbah_rsmu->nh3, 1).'</div>';
                                                                    }else{
                                                                        echo '<div class="badge badge-light-success">'.number_format($limbah_rsmu->nh3, 1).'</div>';
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td class="text-center min-w-75px">
                                                                    <?php if ($limbah_urj->nh3 > "0.1"){
                                                                        echo '<div class="badge badge-light-danger">'.number_format($limbah_urj->nh3, 1).'</div>';
                                                                    }else{
                                                                        echo '<div class="badge badge-light-success">'.number_format($limbah_urj->nh3, 1).'</div>';
                                                                    }
                                                                    ?>
                                                                </td>
