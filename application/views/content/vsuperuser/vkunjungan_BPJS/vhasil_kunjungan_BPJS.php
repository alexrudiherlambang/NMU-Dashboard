                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-0 pt-10">
                                        ...
                                        <div class="card-title"><center>
                                            <form method="post" action="<?php echo site_url(); ?>SuperUser/ckunjungan_BPJS/kunjungan" enctype="multipart/form-data">
                                                <div class="row mb-4">
                                                    <!--begin::Col-->
                                                    <div class="col-xl-5">
                                    ...
                                    <!-- <canvas id="myChart" width="300" height="80"></canvas><br> -->
                                        ...
                                        <!--begin::Table-->
                                            <form method="post" action="<?php echo site_url(); ?>SuperUser/ckunjungan_BPJS/export_xls">
