							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										Data Kegiatan Penunjang Medis</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<?php
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-0 pt-10">
                                        ...
                                        <div class="card-title"><center>
                                            <form method="post" action="<?php echo site_url(); ?>SuperUser/ckunjungan_jangmed/kunjungan" enctype="multipart/form-data">
                                                <div class="row mb-4">
                                                    <!--begin::Col-->
                                                    <div class="col-xl-5">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-xl-5 fv-row">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <input class="form-control form-control-solid ps-12" type="date" name="tglawal" id="tglawal" placeholder="Pick a date" id="tglawal" required="required"  value="<?php $date = new DateTime();$date->modify('-7 days');echo $date->format('Y-m-d');?>"/>
                                                        </div>
                                                    </div>
                                                    <!--begin::Col-->
                                                </div>
                                    ...
                                    <div class="card-body py-4">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <thead>
                                                ...
                                                <tr style="background-color: #000080;" class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th style="color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">Target Kegiatan</th>
                                        ...
                                        <div style="text-align:left"><b>Ket :</b><br>
                                            <i><b>Potensial Kegiatan</b> = Pasien RJ atau RI yang sudah close bill</i><br>
                                            <i><b>Estimasi Total Kegiatan</b> = Penjumlahan total kegiatan saat ini dengan potensial kegiatan</i><br>
                                            <i><b>Prosentase</b> = Total Kegiatan / Target Kegiatan</i><br>
