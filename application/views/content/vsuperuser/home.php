...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									...
									<div class="card mb-1">
										...
										<div class="card-header pt-7">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-gray-800">Grafik Pedapatan Konsolidasi</span>
									...
									<div class="card mb-1">
										...
										<div class="card-header pt-7">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-gray-800">Grafik Beban Konsolidasi</span>
									...
									<div class="card mb-1">
										...
										<div class="card-header pt-7">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-gray-800">Grafik Laba - Rugi Konsolidasi</span>
									...
									<div class="card mb-1">
										...
										<div class="card-header pt-7">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-gray-800">Grafik Kunjungan Rawat Jalan Konsolidasi</span>
									...
									<div class="card mb-1">
										...
										<div class="card-header pt-7">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-gray-800">Grafik Kunjungan Rawat Inap Konsolidasi</span>
									...
									<div class="card mb-1">
										...
										<div class="card-header pt-7">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-gray-800">Grafik Kegiatan Penunjang Medis Konsolidasi</span>
    ...
    <script>
		$(document).ready(function(){
			...
			$.ajax({
			url: '<?php echo site_url('SuperUser/Home/kunjungan_rj') ?>',
			type: 'GET',
			dataType: 'json',
			success: function(data) {
    ...
    <script>
		$(document).ready(function(){
			...
			$.ajax({
			url: '<?php echo site_url('SuperUser/Home/kunjungan_ri') ?>',
			type: 'GET',
			dataType: 'json',
			success: function(data) {
    ...
    <script>
		$(document).ready(function(){
			...
			$.ajax({
			url: '<?php echo site_url('SuperUser/Home/kunjungan_jm') ?>',
			type: 'GET',
			dataType: 'json',
			success: function(data) {
