                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-0 pt-10">
                                        ...
                                        <div class="card-title"><center>
                                            <form method="post" action="<?php echo site_url(); ?>SuperUser/Blank" enctype="multipart/form-data">
                                                <div class="row mb-4">
                                                    <!--begin::Col-->
                                                    <div class="col-xl-5">
                                    ...
                                    <div class="card-body py-4">
                                            ...
                                            <table class="table align-middle gs-0 gy-4">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr style="background-color: #000080;" class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th style="color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">SK Periode Saat Ini</th>
                                                        <th style="color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">Total SK s/d saat ini</th>
                                                        <th style="color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">Potensial SK</th>
                                                        <th style="color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">Estimasi Total SK</th>
                                                        <th style="color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">Target SK</th>
                                        ...
                                        <div style="text-align:left"><b>Ket :</b><br>
                                            <i><b>Potensial SK</b> = Pasien RJ atau RI yang sudah close bill</i><br>
                                            <i><b>Estimasi Total SK</b> = Penjumlahan total SK saat ini dengan potensial SK</i><br>
                                            <i><b>Prosentase</b> = Total SK / Target SK</i><br>
