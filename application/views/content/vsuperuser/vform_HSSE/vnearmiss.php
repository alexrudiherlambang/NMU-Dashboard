                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <!--begin::Add product-->
                                            <?php echo anchor('SuperUser/cform_HSSE/input_nearmiss', '+ Form Nearmiss', array('class' => 'btn btn-sm btn-success', 'type' => 'button')) ?>
                                            <!--end::Add product-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            <a href="<?php echo site_url("SuperUser/cform_HSSE/edit_other/" . $nearmiss->id_other."/nearmiss") ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-shrink-0">
                                                            <a href="<?php echo site_url("SuperUser/cform_HSSE/delete_other/" . $nearmiss->id_other."/nearmiss") ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" onclick="return confirm('Anda yakin hapus pendaftaran ini?');">
                                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                                <span class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/General/Visible.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
