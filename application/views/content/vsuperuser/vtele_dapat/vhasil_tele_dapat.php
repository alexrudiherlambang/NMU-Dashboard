							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										Data Pendapatan Telemedicine</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<?php
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-0 pt-10">
                                        ...
                                        <div class="card-title"><center>
                                            <form method="post" action="<?php echo site_url(); ?>SuperUser/ctele_dapat/pendapatan" enctype="multipart/form-data">
                                            <div class="row mb-4">
                                                    <!--begin::Col-->
                                                    <div class="col-xl-5">
                                            ...
                                            <div class="card card-custom bg-primary">
                                                ...
                                                <div class="card-body pt-5">
                                                    ...
                                                    <?php if ($lokasi =="") :?>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <!--begin::Section-->
                                                            <div class="text-white fw-semibold fs-2 me-5"><b>Total Pendapatan</b></div>
                                                            <!--end::Section-->
                                                            <!--begin::Statistics-->
                                                            <div class="d-flex align-items-senter">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-900 fw-bolder fs-2">Rp <?php echo number_format($total_all, 0, ',', '.'); ?></span>
                                                                <!--end::Number-->
                                                            </div>
                                                            <!--end::Statistics-->
                                                        </div>
                                                    ...
                                                    <?php if ($lokasi =="RSG") :?>
                                                        ...
                                                        <?php foreach ($rinci_rsg as $a) :?><div class="d-flex flex-stack">
                                                                ...
                                                                <div class="d-flex align-items-senter">
                                                                    <!--begin::Number-->
                                                                    <span class="text-gray-900 fw-bolder fs-6">Rp <?php echo number_format($a->jumlah, 0, ',', '.'); ?></span>
                                                                    <!--end::Number-->
                                                                </div>
                                                                <!--end::Statistics-->
                                                            </div>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <!--begin::Section-->
                                                            <div class="text-white fw-semibold fs-3 me-2">Pendapatan RS Gatoel</div>
                                                            <!--end::Section-->
                                                            <!--begin::Statistics-->
                                                            <div class="d-flex align-items-senter">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-900 fw-bolder fs-3">Rp <?php echo number_format($total_rsg->jumlah, 0, ',', '.'); ?></span>
                                                                <!--end::Number-->
                                                            </div>
                                                            <!--end::Statistics-->
                                                        </div>
                                                    ...
                                                    <?php if ($lokasi =="RSP") :?>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <!--begin::Section-->
                                                            <div class="text-white fw-semibold fs-3 me-2">Pendapatan RS Perkebunan</div>
                                                            <!--end::Section-->
                                                            <!--begin::Statistics-->
                                                            <div class="d-flex align-items-senter">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-900 fw-bolder fs-3">Rp <?php echo number_format($total_rsp->jumlah, 0, ',', '.'); ?></span>
                                                                <!--end::Number-->
                                                            </div>
                                                            <!--end::Statistics-->
                                                        </div>
                                                    ...
                                                    <?php if ($lokasi =="RST") :?>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <!--begin::Section-->
                                                            <div class="text-white fw-semibold fs-3 me-2">Pendapatan RS Toeloengredjo</div>
                                                            <!--end::Section-->
                                                            <!--begin::Statistics-->
                                                            <div class="d-flex align-items-senter">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-900 fw-bolder fs-3">Rp <?php echo number_format($total_rst->jumlah, 0, ',', '.'); ?></span>
                                                                <!--end::Number-->
                                                            </div>
                                                            <!--end::Statistics-->
                                                        </div>
                                                    ...
                                                    <?php if ($lokasi =="RSMU") :?>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <!--begin::Section-->
                                                            <div class="text-white fw-semibold fs-3 me-2">Pendapatan RS Medika Utama</div>
                                                            <!--end::Section-->
                                                            <!--begin::Statistics-->
                                                            <div class="d-flex align-items-senter">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-900 fw-bolder fs-3">Rp <?php echo number_format($total_rsmu->jumlah, 0, ',', '.'); ?></span>
                                                                <!--end::Number-->
                                                            </div>
                                                            <!--end::Statistics-->
                                                        </div>
                                                    ...
                                                    <?php if ($lokasi =="URJ") :?>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <!--begin::Section-->
                                                            <div class="text-white fw-semibold fs-3 me-2">Pendapatan URJ</div>
                                                            <!--end::Section-->
                                                            <!--begin::Statistics-->
                                                            <div class="d-flex align-items-senter">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-900 fw-bolder fs-3">Rp <?php echo number_format($total_urj->jumlah, 0, ',', '.'); ?></span>
                                                                <!--end::Number-->
                                                            </div>
                                                            <!--end::Statistics-->
                                                        </div>
