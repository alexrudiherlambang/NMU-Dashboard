                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-xl-5 fv-row">
                                                        <select class="form-select form-select-solid select2" name="filter" >
                                                            ...
                                                            <option value="golkary">Status Kepegawaian</option>
                                                            <option value="nmfungsi">Fungsi</option>
                                                            <option value="nmsub">Sub Fungsi</option>
                                                            <option value="nmdidik">Jenjang Pendidikan</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5">
                                                ...
                                                <tbody class="text-gray-600 fw-semibold">
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px"><b>KP</b></td>
                                                        <td class="text-center min-w-150px">Kategori A</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">RSG</td>
                                                        <td class="text-center min-w-150px"><b>Kategori B</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">RST</td>
                                                        <td class="text-center min-w-150px"><b>Kategori C</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">RSP</td>
                                                        <td class="text-center min-w-150px"><b>Kategori D</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">RSMU</td>
                                                        <td class="text-center min-w-150px"><b>Kategori E</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center min-w-100px">KLINIK</td>
                                                        <td class="text-center min-w-150px"><b>Kategori F</b></td>
                                                        <td class="text-center min-w-100px"><?php echo date('M-y');?></td>
                                                        <td style="background-color: #0099FF; color: #ffffff; vertical-align: middle;" class="text-center min-w-100px">0</td>
                                                    </tr>
